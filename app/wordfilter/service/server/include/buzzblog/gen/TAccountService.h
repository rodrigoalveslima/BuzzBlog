...
class TAccountServiceIf {
 public:
  ...
  virtual void list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset) = 0;
};
...
class TAccountServiceNull : virtual public TAccountServiceIf {
 public:
  ...
  void list_accounts(std::vector<TAccount> & /* _return */, const TRequestMetadata& /* request_metadata */, const TAccountQuery& /* query */, const int32_t /* limit */, const int32_t /* offset */) {
    return;
  }
};
...
typedef struct _TAccountService_list_accounts_args__isset {
  _TAccountService_list_accounts_args__isset() : request_metadata(false), query(false), limit(false), offset(false) {}
  bool request_metadata :1;
  bool query :1;
  bool limit :1;
  bool offset :1;
} _TAccountService_list_accounts_args__isset;

class TAccountService_list_accounts_args {
 public:

  TAccountService_list_accounts_args(const TAccountService_list_accounts_args&);
  TAccountService_list_accounts_args& operator=(const TAccountService_list_accounts_args&);
  TAccountService_list_accounts_args() : limit(0), offset(0) {
  }

  virtual ~TAccountService_list_accounts_args() noexcept;
  TRequestMetadata request_metadata;
  TAccountQuery query;
  int32_t limit;
  int32_t offset;

  _TAccountService_list_accounts_args__isset __isset;

  void __set_request_metadata(const TRequestMetadata& val);

  void __set_query(const TAccountQuery& val);

  void __set_limit(const int32_t val);

  void __set_offset(const int32_t val);

  bool operator == (const TAccountService_list_accounts_args & rhs) const
  {
    if (!(request_metadata == rhs.request_metadata))
      return false;
    if (!(query == rhs.query))
  ...
  bool operator < (const TAccountService_list_accounts_args & ) const;
...
class TAccountService_list_accounts_pargs {
 public:


  virtual ~TAccountService_list_accounts_pargs() noexcept;
  const TRequestMetadata* request_metadata;
...
typedef struct _TAccountService_list_accounts_result__isset {
  _TAccountService_list_accounts_result__isset() : success(false) {}
  bool success :1;
} _TAccountService_list_accounts_result__isset;

class TAccountService_list_accounts_result {
 public:

  TAccountService_list_accounts_result(const TAccountService_list_accounts_result&);
  TAccountService_list_accounts_result& operator=(const TAccountService_list_accounts_result&);
  TAccountService_list_accounts_result() {
  }

  virtual ~TAccountService_list_accounts_result() noexcept;
  std::vector<TAccount>  success;

  _TAccountService_list_accounts_result__isset __isset;

  void __set_success(const std::vector<TAccount> & val);

  bool operator == (const TAccountService_list_accounts_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const TAccountService_list_accounts_result & ) const;
...
typedef struct _TAccountService_list_accounts_presult__isset {
  _TAccountService_list_accounts_presult__isset() : success(false) {}
  bool success :1;
} _TAccountService_list_accounts_presult__isset;

class TAccountService_list_accounts_presult {
 public:


  virtual ~TAccountService_list_accounts_presult() noexcept;
  std::vector<TAccount> * success;

  _TAccountService_list_accounts_presult__isset __isset;
...
class TAccountServiceClient : virtual public TAccountServiceIf {
 ...
 public:
  ...
  void list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset);
  void send_list_accounts(const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset);
  void recv_list_accounts(std::vector<TAccount> & _return);
 protected:
...
class TAccountServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 private:
  ...
  void process_list_accounts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 public:
  TAccountServiceProcessor(::std::shared_ptr<TAccountServiceIf> iface) :
    ...
    processMap_["list_accounts"] = &TAccountServiceProcessor::process_list_accounts;
  }
...
class TAccountServiceMultiface : virtual public TAccountServiceIf {
 ...
 public:
  ...
  void list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->list_accounts(_return, request_metadata, query, limit, offset);
    }
    ifaces_[i]->list_accounts(_return, request_metadata, query, limit, offset);
    return;
  }
  ...
  TAccountServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset);
  int32_t send_list_accounts(const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset);
  void recv_list_accounts(std::vector<TAccount> & _return, const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
