...
TAccountService_list_accounts_args::~TAccountService_list_accounts_args() noexcept {
}


uint32_t TAccountService_list_accounts_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TAccountService_list_accounts_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TAccountService_list_accounts_args");
...
TAccountService_list_accounts_pargs::~TAccountService_list_accounts_pargs() noexcept {
}


uint32_t TAccountService_list_accounts_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TAccountService_list_accounts_pargs");
...
TAccountService_list_accounts_result::~TAccountService_list_accounts_result() noexcept {
}


uint32_t TAccountService_list_accounts_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t TAccountService_list_accounts_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("TAccountService_list_accounts_result");

  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<TAccount> ::const_iterator _iter61;
...
TAccountService_list_accounts_presult::~TAccountService_list_accounts_presult() noexcept {
}


uint32_t TAccountService_list_accounts_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void TAccountServiceClient::list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset)
{
  send_list_accounts(request_metadata, query, limit, offset);
  recv_list_accounts(_return);
}

void TAccountServiceClient::send_list_accounts(const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("list_accounts", ::apache::thrift::protocol::T_CALL, cseqid);

  TAccountService_list_accounts_pargs args;
  args.request_metadata = &request_metadata;
  args.query = &query;
  args.limit = &limit;
  args.offset = &offset;
...
void TAccountServiceClient::recv_list_accounts(std::vector<TAccount> & _return)
{
  ...
  if (fname.compare("list_accounts") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  TAccountService_list_accounts_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "list_accounts failed: unknown result");
}
...
void TAccountServiceProcessor::process_list_accounts(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("TAccountService.list_accounts", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "TAccountService.list_accounts");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "TAccountService.list_accounts");
  }

  TAccountService_list_accounts_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "TAccountService.list_accounts", bytes);
  }

  TAccountService_list_accounts_result result;
  try {
    iface_->list_accounts(result.success, args.request_metadata, args.query, args.limit, args.offset);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "TAccountService.list_accounts");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("list_accounts", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "TAccountService.list_accounts");
  }

  oprot->writeMessageBegin("list_accounts", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "TAccountService.list_accounts", bytes);
  }
}
...
void TAccountServiceConcurrentClient::list_accounts(std::vector<TAccount> & _return, const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset)
{
  int32_t seqid = send_list_accounts(request_metadata, query, limit, offset);
  recv_list_accounts(_return, seqid);
}

int32_t TAccountServiceConcurrentClient::send_list_accounts(const TRequestMetadata& request_metadata, const TAccountQuery& query, const int32_t limit, const int32_t offset)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("list_accounts", ::apache::thrift::protocol::T_CALL, cseqid);
...
void TAccountServiceConcurrentClient::recv_list_accounts(std::vector<TAccount> & _return, const int32_t seqid)
{
