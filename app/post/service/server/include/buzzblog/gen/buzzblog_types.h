...
typedef struct _TAccountQuery__isset {
  _TAccountQuery__isset() : username(false) {}
  bool username :1;
} _TAccountQuery__isset;

class TAccountQuery : public virtual ::apache::thrift::TBase {
 public:

  TAccountQuery(const TAccountQuery&);
  TAccountQuery& operator=(const TAccountQuery&);
  TAccountQuery() : username() {
  }

  virtual ~TAccountQuery() noexcept;
  std::string username;

  _TAccountQuery__isset __isset;

  void __set_username(const std::string& val);

  bool operator == (const TAccountQuery & rhs) const
  {
  ...
  bool operator < (const TAccountQuery & ) const;
...
typedef struct _TLike__isset {
  _TLike__isset() : account(false), post(false) {}
  bool account :1;
  bool post :1;
} _TLike__isset;
